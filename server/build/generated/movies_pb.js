...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.mongomovies.Movie.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            genresList: jspb.Message.toObjectList(msg.getGenresList(), proto.mongomovies.Genre.toObject, includeInstance),
            runtime: jspb.Message.getFieldWithDefault(msg, 4, 0),
            rated: jspb.Message.getFieldWithDefault(msg, 5, ""),
            castList: jspb.Message.toObjectList(msg.getCastList(), proto.mongomovies.Cast.toObject, includeInstance),
            ...
            languagesList: jspb.Message.toObjectList(msg.getLanguagesList(), proto.mongomovies.Language.toObject, includeInstance),
            released: jspb.Message.getFieldWithDefault(msg, 12, ""),
            directorsList: jspb.Message.toObjectList(msg.getDirectorsList(), proto.mongomovies.Director.toObject, includeInstance),
            writersList: jspb.Message.toObjectList(msg.getWritersList(), proto.mongomovies.Writer.toObject, includeInstance),
            lastupdated: jspb.Message.getFieldWithDefault(msg, 15, ""),
            year: jspb.Message.getFieldWithDefault(msg, 16, ""),
            countriesList: jspb.Message.toObjectList(msg.getCountriesList(), proto.mongomovies.Country.toObject, includeInstance),
...
proto.mongomovies.Movie.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.mongomovies.Genre.serializeBinaryToWriter);
    }
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(6, f, proto.mongomovies.Cast.serializeBinaryToWriter);
    }
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(11, f, proto.mongomovies.Language.serializeBinaryToWriter);
    }
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(13, f, proto.mongomovies.Director.serializeBinaryToWriter);
    }
    f = message.getWritersList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(14, f, proto.mongomovies.Writer.serializeBinaryToWriter);
    }
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(17, f, proto.mongomovies.Country.serializeBinaryToWriter);
    }
    f = message.getType();
    if (f.length > 0) {
...
proto.mongomovies.Movie.prototype.getGenresList = function () {
    return /** @type{!Array<!proto.mongomovies.Genre>} */ (jspb.Message.getRepeatedWrapperField(this, proto.mongomovies.Genre, 3));
};
/**
...
proto.mongomovies.Movie.prototype.getCastList = function () {
    return /** @type{!Array<!proto.mongomovies.Cast>} */ (jspb.Message.getRepeatedWrapperField(this, proto.mongomovies.Cast, 6));
};
/**
...
proto.mongomovies.Movie.prototype.getLanguagesList = function () {
    return /** @type{!Array<!proto.mongomovies.Language>} */ (jspb.Message.getRepeatedWrapperField(this, proto.mongomovies.Language, 11));
};
/**
...
proto.mongomovies.Movie.prototype.getDirectorsList = function () {
    return /** @type{!Array<!proto.mongomovies.Director>} */ (jspb.Message.getRepeatedWrapperField(this, proto.mongomovies.Director, 13));
};
/**
...
proto.mongomovies.Movie.prototype.getWritersList = function () {
    return /** @type{!Array<!proto.mongomovies.Writer>} */ (jspb.Message.getRepeatedWrapperField(this, proto.mongomovies.Writer, 14));
};
/**
...
proto.mongomovies.Movie.prototype.getCountriesList = function () {
    return /** @type{!Array<!proto.mongomovies.Country>} */ (jspb.Message.getRepeatedWrapperField(this, proto.mongomovies.Country, 17));
};
/**
...
proto.mongomovies.Request.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getMovie();
    if (f != null) {
        writer.writeMessage(2, f, proto.mongomovies.Movie.serializeBinaryToWriter);
    }
    f = message.getData();
    if (f.length > 0) {
...
proto.mongomovies.Request.prototype.getMovie = function () {
    return /** @type{?proto.mongomovies.Movie} */ (jspb.Message.getWrapperField(this, proto.mongomovies.Movie, 2));
};
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.mongomovies.Response.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            moviesList: jspb.Message.toObjectList(msg.getMoviesList(), proto.mongomovies.Movie.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.mongomovies.Response.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(4, f, proto.mongomovies.Movie.serializeBinaryToWriter);
    }
};
/**
...
proto.mongomovies.Response.prototype.getMoviesList = function () {
    return /** @type{!Array<!proto.mongomovies.Movie>} */ (jspb.Message.getRepeatedWrapperField(this, proto.mongomovies.Movie, 4));
};
/**
