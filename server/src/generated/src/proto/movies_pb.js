...
proto.Movie.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.Genre.toObject, includeInstance),
    ...
    proto.Cast.toObject, includeInstance),
    ...
    proto.Writer.toObject, includeInstance),
...
proto.Movie.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.Genre.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      6,
      f,
      proto.Cast.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      14,
      f,
      proto.Writer.serializeBinaryToWriter
    );
  }
...
proto.Movie.prototype.getGenresList = function() {
  return /** @type{!Array<!proto.Genre>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Genre, 3));
};
...
proto.Movie.prototype.getCastList = function() {
  return /** @type{!Array<!proto.Cast>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Cast, 6));
};
...
proto.Movie.prototype.getLanguagesList = function() {
  return /** @type{!Array<!proto.Language>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Language, 11));
};
...
proto.Movie.prototype.getDirectorsList = function() {
  return /** @type{!Array<!proto.Director>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Director, 13));
};
...
proto.Movie.prototype.getWritersList = function() {
  return /** @type{!Array<!proto.Writer>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Writer, 14));
};
...
proto.Movie.prototype.getCountriesList = function() {
  return /** @type{!Array<!proto.Country>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Country, 17));
};
...
proto.Response.prototype.getMoviesList = function() {
  return /** @type{!Array<!proto.Movie>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Movie, 4));
};
